...
Après l'installation, redémarrez votre session Claude Code. La commande est disponible via `/skill-test`.
...
```
~/.claude/commands/skill-test.md     # point d'entrée de la commande /skill-test
